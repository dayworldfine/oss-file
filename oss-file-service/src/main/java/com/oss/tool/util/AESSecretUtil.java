...
public class AESSecretUtil {
    ...
    public static final String BASE64SECRET = "123456";

    //超时毫秒数（默认30分钟）
    public static final int EXPIRESSECOND = 1800000;

    //用于JWT加密的密匙 自定义
    public static final String DATAKEY = "ABC";
    ...
    public static String encryptToStr(String data, String key) {
        ...
        return ValidateUtil.isNotEmpty(data) ? parseByte2HexStr(encrypt(data, key)) : null;
    }
    ...
    public static String decryptToStr(String enCryptdata, String key) {
        return ValidateUtil.isNotEmpty(enCryptdata) ? new String(decrypt(parseHexStr2Byte(enCryptdata), key)) : null;
    }
...
//        String ss = encryptToStr("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiIxMjMiLCJ1c2VyTmFtZSI6Ikp1ZHkiLCJleHAiOjE1MzI3Nzk2MjIsIm5iZiI6MTUzMjc3NzgyMn0.sIw_leDZwG0pJ8ty85Iecd_VXjObYutILNEwPUyeVSo", DATAKEY);
